...
${P_ASSOCIATE} -i ${cat}_tmp_$$ ${TWOdFLenS_cat} \
...
${P_LDACFILTER} -i $wd/merg_2dFLenS_comp.cat_$$ -o $wd/merg_2dFLenS_comp2.cat_$$ \
		-t PSSC -c "RICHNESS>1;"
echo

${P_LDACRENTAB} -i $wd/merg_2dFLenS_comp2.cat_$$ -o $wd/${base}_2dFLenS.cat \
		-t PSSC OBJECTS
