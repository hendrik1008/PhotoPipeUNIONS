...
h = hist2d=ax.hist2d(z_spec, z_phot, weights=weight, normed=True, bins=100, range=((0.,2.),(0.,2.)), norm=ml.colors.LogNorm(vmin=0.15,vmax=15.), cmap='YlOrRd')
...
ax.set_xlim(0.,1.65)
ax.set_ylim(0.,1.65)
h3_norm = h[3]/np.max(h[3])
plt.colorbar(h3_norm, ax=ax)
