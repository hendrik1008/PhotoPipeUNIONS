...
ALLMODES=`echo CONVERT PREPARE GAIAPREP GAUSSIANISE GAAP COMBINETILE SDSSPREP ZPREP PSPREP PGMPREP \
               COMPTILE COMPTILEPS COMPTILEPGM MERGE COMPTILEPOSTMERGE COMPTILEPSPOSTMERGE COMPTILEPGMPOSTMERGE \
	       BPZ BPZRECALIB BPZRECALIBPLUS BPZRECALIBSDSS BPZRECALIBSDSSPLUS \
	       COMPTILEZ MASK QC \
	       CLEAN COPY COPYBACK CHECKFAIL ERASE`
MODELIST=""
while [ $# -gt 0 ]
do 
  for MODE in $1
