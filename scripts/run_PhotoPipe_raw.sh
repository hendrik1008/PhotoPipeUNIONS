...
ALLMODES=`echo CONVERT PREPARE GAIAPREP GAUSSIANISE GAAP COMBINETILE SDSSPREP ZPREP PSPREP \
               COMPTILE COMPTILEPS MERGE COMPTILEPOSTMERGE COMPTILEPSPOSTMERGE \
