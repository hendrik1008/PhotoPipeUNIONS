...
# saturation levels
case $band in
    "u")  sat_level=`dfits_theli $measurement_image | fitsort_theli -d SATURATE|awk '{print $2}'`; ZP=`dfits_theli $measurement_image | fitsort_theli -d PHOTZP|awk '{print $2}'`;;
    "g")  sat_level=45000; ZP=27;;
    "r")  sat_level=`dfits_theli $measurement_image | fitsort_theli -d SATURATE|awk '{print $2}'`; ZP=`dfits_theli $measurement_image | fitsort_theli -d PHOTZP|awk '{print $2}'`;;
