 ...
 *
 * 17.12.2015:
 * I defined values for the version and the program date.
 *
 * 18.12.2015:
 * I included global_vers.h for THELI version number
 * information
 */
...
#define		VERSION		"1.12 (THELI version)"
#define		DATE		"2015-14-12"
#define		THREADS_NMAX	128		/* max. number of threads */
#endif

/*------------------------ what, who, when and where ------------------------*/

#define         BANNER          "WeightWatcher"
#define		EXECUTABLE	"ww_theli"
...
#define		WEBSITE		"http://astromatic.net/software/weightwatcher"
