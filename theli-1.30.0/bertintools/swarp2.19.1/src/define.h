...
/*
  ...
  28.05.2015:
  I increased the THREAD_MAX from 16 to 1024. This was just a
  'theoretical limit' up to now as we never use single swarp calls
  with a heigh thread number in THELI. But it is just necessary
  and hence I remove it.
*/
