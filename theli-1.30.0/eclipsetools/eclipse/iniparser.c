...
/*
    $Id: iniparser.c,v 1.1 2003/09/04 15:44:34 terben Exp $
    $Author: terben $
 ...
 */
/*--------------------------------------------------------------------------*/
char * iniparser_getstr(dictionary * d, char * key, char * def)
{
    char * lc_key ;
    char * sval ;
...
int iniparser_getint(dictionary * d, char * key, int notfound)
{
    ...
    str = iniparser_getstr(d, key, INI_INVALID_KEY);
...
int iniparser_getboolean(dictionary * d, char * key, int notfound)
{
    ...
    c = iniparser_getstr(d, key, INI_INVALID_KEY);
...
{
    int found=0 ;
    if (iniparser_getstr(ini, entry, INI_INVALID_KEY)!=INI_INVALID_KEY) {
        found = 1 ;
    }
    return found ;
}
