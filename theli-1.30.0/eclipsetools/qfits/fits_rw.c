...
/*
    $Id: fits_rw.c,v 1.3 2018/03/28 12:06:21 thomas Exp $
    $Author: thomas $
...
/* 20.07.2015:
   function qfits_header_readext:
   A variable was changed from type int to long int. DECam MEF-data
   can be larger than 2GB in float format and hence file-pointers need
   a variable type that can hold such large numbers.
*/
