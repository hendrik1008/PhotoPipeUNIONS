...
/*
    $Id: simple.c,v 1.4 2018/03/28 12:06:22 thomas Exp $
    $Author: thomas $
...
/* 24.01.2005:
   ...
   20.07.2015:
   functions qfits_query_ext and qfits_query_hdr:
   variables specifiying a file position was changed from int
