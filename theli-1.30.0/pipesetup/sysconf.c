...
/*
        $Id: sysconf.c,v 1.2 2010/09/06 21:12:58 thomas Exp $
        $Author: thomas $
        $Date: 2010/09/06 21:12:58 $
        $Revision: 1.2 $
 */
...
/*
   06.09.2010:
   I substituted the format '%d' by '%zu' for sizeof expressions.
   The former led to compiler warnings.
 */
...
void make_config_h()
{
  ...
  fprintf(out,
          "#define SIZEOF_CHAR     %zu\n"
          "#define SIZEOF_SHORT    %zu\n"
          "#define SIZEOF_INT      %zu\n"
          "#define SIZEOF_LONG     %zu\n"
          "#define SIZEOF_FLOAT    %zu\n"
          "#define SIZEOF_DOUBLE   %zu\n",
          sizeof(char),
          sizeof(short),
          sizeof(int),
          sizeof(long),
