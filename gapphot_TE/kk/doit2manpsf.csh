...
sex inimage.fits
awk '{if($1!="#" && $10==0) print($1,$2,$3,$4,2*$5,$6,$7,$8,$9,$10)}' test.cat >test.cat2

#manual star locus finder
#nice selectpsfstars < test.cat2 > psf.cat

# alternatively:
# specify the box where stars should be, e.g.
awk '$1>3660 || $1<60 || $2>3660 || $2<60' test.cat2 > psf.cat

# make psf map
nice psfcat2sh < psf.cat > psf.sh
nice fitpsfmap < psf.sh > psf.map
nice showpsfmap < psf.map 

# Encode the source catalogue (only sources bigger than 1.1 beta)
nice cat2sherr < test.cat2 | sortbybeta > test.sh
