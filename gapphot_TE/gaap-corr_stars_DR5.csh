...
if ! ($# == 11) then
 echo Usage: gaap.csh \<LDACcat\> \<pre-GPSFimg\> \<GPSFimg\> \<wtimg\> \<minaper\> \<maxaper\> \<kermap\> \<out\> \<GAaP_dir\> \<RA_key\> \<Dec_key\>
 exit
endif
...
ldactoasc -i $cat -t OBJECTS -s -b -k \
    $phot_cat_RA $phot_cat_Dec MAG_AUTO MAGERR_AUTO \
    FLUX_RADIUS A_WORLD B_WORLD THETA_J2000 SeqNr \
    | awk '{print $1, $2, -99, 0.1, '$minaper', 0, 0, 0, $9}' \
    > $catsky
...
\rm -f gpsfsig.dat inimage.fits weights.fits xy.cat radec.cat # gaap.in
